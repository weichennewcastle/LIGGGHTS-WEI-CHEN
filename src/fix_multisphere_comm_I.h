...
int pack_comm(int n, int *list, double *buf, int pbc_flag, int *pbc)
{
    ...
    else error->fix_error(FLERR,this,"pack_comm internal error");
    return 0;
}

/* ---------------------------------------------------------------------- */

int pack_comm_body(int n, int *list, double *buf, int pbc_flag, int *pbc)
{
...
int pack_comm_image_displace(int n, int *list, double *buf, int pbc_flag, int *pbc)
{
...
int pack_comm_v_omega(int n, int *list, double *buf, int pbc_flag, int *pbc)
{
    double **v = atom->v;
...
int pack_comm_f_torque(int n, int *list, double *buf, int pbc_flag, int *pbc)
{
    double **f = atom->f;
...
void unpack_comm(int n, int first, double *buf)
{
    ...
    else error->fix_error(FLERR,this,"unpack_comm internal error");
}

/* ---------------------------------------------------------------------- */

void unpack_comm_body(int n, int first, double *buf)
{
    int i,m,last;
...
void unpack_comm_image_displace(int n, int first, double *buf)
{
    int i,m,last;
    int *aimage = atom->image;
...
void unpack_comm_v_omega(int n, int first, double *buf)
{
    double **v = atom->v;
    double **omega = atom->omega;
...
void unpack_comm_f_torque(int n, int first, double *buf)
{
    int i,m,last,flag;
    double **f = atom->f;
    double **torque = atom->torque;
...
int pack_reverse_comm(int n, int first, double *buf)
{
    ...
    else error->fix_error(FLERR,this,"pack_reverse_comm internal error");
    return 0;
}

/* ---------------------------------------------------------------------- */

int pack_reverse_comm_x_v_omega(int n, int first, double *buf)
{
...
int pack_reverse_comm_v_omega(int n, int first, double *buf)
{
    int i,m,last,tag,flag;
...
void unpack_reverse_comm(int n, int *list, double *buf)
{
    ...
    else error->fix_error(FLERR,this,"unpack_reverse_comm internal error");
}

/* ---------------------------------------------------------------------- */

void unpack_reverse_comm_x_v_omega(int n, int *list, double *buf)
{
    int i,j,flag,m = 0;
...
void unpack_reverse_comm_v_omega(int n, int *list, double *buf)
{
    int i,j,flag,m = 0;
