  ...
  Fix(lmp, narg, arg)
{
    ...
    /*if (0 == strncmp(style,"wall/gran/omp",13)) { //C.R. Hack for omp wallstyle
     int64_t variant = Factory::instance().selectVariant("wall/gran/omp", nremaining, remaining_args);
     impl = Factory::instance().create("wall/gran/omp", variant, lmp, this);
    }
    else {
     int64_t variant = Factory::instance().selectVariant("wall/gran", nremaining, remaining_args);
     impl = Factory::instance().create("wall/gran", variant, lmp, this);
    }*/
